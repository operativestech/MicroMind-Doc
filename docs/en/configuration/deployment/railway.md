...
That's it! You now have a deployed aimicromind on Railway [🎉](https://emojipedia.org/party-popper/)[🎉](https://emojipedia.org/party-popper/)

## Persistent Volume

The default filesystem for services running on Railway is ephemeral. aimicromind data isn’t persisted across deploys and restarts. To solve this issue, we can use [Railway Volume](https://docs.railway.app/reference/volumes).
...
* DATABASE\_PATH - `/opt/railway/.aimicromind`
* APIKEY\_PATH - `/opt/railway/.aimicromind`
* LOG\_PATH - `/opt/railway/.aimicromind/logs`
* SECRETKEY\_PATH - `/opt/railway/.aimicromind`
* BLOB\_STORAGE\_PATH - `/opt/railway/.aimicromind/storage`
