...
4. _(Optional)_ You can also specify `AIMICROMIND_USERNAME` and `AIMICROMIND_PASSWORD` for app level authorization. See more [broken-reference](broken-reference/ "mention")
