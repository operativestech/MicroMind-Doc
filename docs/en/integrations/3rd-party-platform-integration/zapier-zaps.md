...
2. Refer [deployment](../../configuration/deployment/) to create a cloud hosted version of AiMicromind.
...
1.  Click **+**, click or search for **AiMicromind**
...
3.  Click **Sign in** and insert your details, then click **Yes, Continue to AiMicromind**
...
4.  Select your prefered Channel for channel and select **Text** and **String Source** (if available) from AiMicromind for Message Text, then click **Continue**
