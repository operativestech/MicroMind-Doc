...
With the same example as above, we are going to create a custom tool that will calls the [Prediction API](../using-aimicromind/api.md#prediction-api) of the Chain of Thought chatflow.
