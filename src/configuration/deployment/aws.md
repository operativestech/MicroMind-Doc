...
Example of command to deploy aimicromind using the [AWS CLI](https://aws.amazon.com/fr/cli/):
...
The Terraform files (`variables.tf`, `main.tf`) are available in this GitHub repository: [terraform-aimicromind-setup](https://github.com/operativestech/AiMicroMind_Platform_2025/tree/main).
