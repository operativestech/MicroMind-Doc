...
For other [Document Loaders](https://github.com/operativestech/MicroMind-Doc/integrations/langchain/document-loaders) nodes without Upload File functionality, the API body is in **JSON** format:
