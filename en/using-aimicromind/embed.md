...
{% hint style="warning" %}
In aimicromind**v2.1.0**, we have modified the way streaming works. If your aimicromindversion is lower than that, you might find your embedded chatbot not able to receive messages.

You can either update aimicromind to **v2.1.0** and above

Or, if for some reason you prefer not to update AiMicromind , you can specify the latest **v1.x.x** version of [AiMicromind -Embed](https://www.npmjs.com/package/aimicromind-embed?activeTab=versions). Last maintained `web.js` version is **v1.3.14.**
...
**Note:** See full [configuration list](https://github.com/operativestech/AiMicroMind_Platform_2025/ChatEmbed/configuration)

## Custom Code Modification

To modify the full source code of embedded chat widget, follow these steps:

1. Fork the [AiMicromindChat Embed](https://github.com/operativestech/AiMicroMind_Platform_2025/ChatEmbed) repository
...
<pre><code><strong>https://unpkg.com/aimicromind-embed/dist/web.js
</strong></code></pre>
{% endhint %}
...
{% hint style="danger" %}
Access to fetch at 'https://\<your-aimicromind.com>/api/v1/prediction/' from origin 'https://\<your-aimicromind.com>' has been blocked by CORS policy: No 'Access-Control-Allow-Origin' header is present on the requested resource.
{% endhint %}
